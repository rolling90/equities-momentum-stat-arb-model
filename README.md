...
The strategy generates momentum long/short trade entry signals for single name equities that are validated by autocorrelation and a market regime "risk on/off" indicator.
